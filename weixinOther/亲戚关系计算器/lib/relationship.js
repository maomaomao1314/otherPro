var f, d, s = require("../@babel/runtime/helpers/interopRequireDefault"), l = s(require("../@babel/runtime/helpers/defineProperty")), e = s(require("../@babel/runtime/helpers/typeof"));
...
f = "undefined" != typeof window ? window : void 0, d = function() {
    ...
    function d(f) {
        for (var d = (f = f.replace(/[二|三|四|五|六|七|八|九|十]{1,2}/g, "x")).replace("我", "").replace("家的", "的").replace("家", "的").split("的"), s = [], l = !0; d.length; ) {
            var e = d.shift(), t = [], x = !1;
            for (var a in u) {
                u[a].indexOf(e) > -1 && (!a && d.length || t.push(a), x = !0);
            }
            if (x || (l = !1), s.length) {
                var m = [];
    ...
    function s(f, d) {
        var s = [], l = {};
        if (d < 0 && (0 == f.indexOf(",w") ? d = 1 : 0 == f.indexOf(",h") && (d = 0)), d > -1 && (f = "," + d + f), 
        f.match(/,[w0],w|,[h1],h/)) return !1;
        return function f(d) {
            var e = "";
            if (!l[d]) {
                l[d] = !0;
    ...
    (0, l.default)(f, "f,m,xb,w", [ "舅婆", "舅祖母", "舅奶奶", "舅奶", "妗婆", "太舅母" ]), (0, l.default)(f, "f,m,xb,s&o", [ "舅表伯父", "表伯父", "表伯" ]), 
    ...
    (0, l.default)(f, "m", [ "妈妈", "母亲", "老妈", "阿妈", "老母", "老妈子", "妈", "母", "娘", "娘亲", "妈咪" ]), 
    ...
    (0, l.default)(f, "w,ls", [ "小姨子", "小姨妹", "妻妹", "小妹儿" ]), (0, l.default)(f, "w,ls,h", [ "小姨夫", "小姨妹夫", "襟弟", "连襟", "姨夫" ]), 
    ...
    (0, l.default)(f, "d,h", [ "女婿", "姑爷", "女婿子", "女婿儿", "儿婿" ]), (0, l.default)(f, "d,h,xb", [ "姻侄" ]), 
    ...
    (0, l.default)(f, "s,w,f,ls", [ "姻妹", "姻亲" ]), (0, l.default)(f, "t", [ "老师", "师父", "师" ]), 
    (0, l.default)(f, "t,w", [ "师娘", "师母" ]), (0, l.default)(f, "t,t", [ "师祖", "师公", "师爷", "太师父" ]), 
    (0, l.default)(f, "t,t,t", [ "太师祖" ]), f), m = function(f) {
    ...
    return function(f) {
        ...
        for (var a in f) l[a] = f[a];
        for (var u = d(l.text), b = [], w = 0; w < u.length; w++) for (var h = s(u[w], l.sex), o = 0; o < h.length; o++) {
            var r = h[o];
            if ("chain" == l.type) {
                var p = x(r);
                p && b.push(p);
            } else {
                l.reverse && (r = t(r, l.sex));
                var n = e(r);
                n.length ? b = b.concat(n) : 0 != r.indexOf("w") && 0 != r.indexOf("h") || (n = e(r.substr(2))).length && (b = b.concat(n));
            }
        }
        return m(b);
    };
